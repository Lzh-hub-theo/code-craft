package com.yu.ai.yuaicodemother.langgraph4j.tools;

import com.yu.ai.yuaicodemother.langgraph4j.model.ImageResource;
import com.yu.ai.yuaicodemother.langgraph4j.model.enums.ImageCategoryEnum;
...
class MermaidDiagramToolTest {
    ...
    void testGenerateArchitectureDiagram() {
        ...
        List<ImageResource> diagrams = mermaidDiagramTool.generateArchitectureDiagram(mermaidCode, description);
